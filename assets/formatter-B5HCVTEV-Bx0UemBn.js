...
import { m as ea } from "./DocsRenderer-K4EAMTCU-CQZ9ptKz.js";
import "./iframe-BnNJRw71.js";
import "../sb-preview/runtime.js";
import "./index-Cu9bd8lq.js";
import "./react-18-ZytopnYu.js";
import "./emotion-use-insertion-effect-with-fallbacks.browser.esm-Bcg3o4Lk.js";
import "./extends-CCbyfPlC.js";
import "./index-B_J8iUie.js";
import "./inheritsLoose-B7h9gheN.js";
import "./getPrototype-DkXlm8sv.js";
...
`
    ...
    _consumeStartTag(t) {
      ...
      this._pushContainer(
        D,
        p instanceof oe && this.getTagDefinition(p.name).isClosedByChild(D.name)
      ),
        a
...
var rp = tp,
  ...
  np = (e, t, { descriptor: r }) => {
    ...
    return (
      t &&
        n.push(
          `we now treat it as ${Un.default.blue(
...
function Gn(e, t, r, n) {
  return [
    ...
    `but received ${
      t === bi ? Le.default.gray("nothing") : Le.default.red(n.value(t))
    }.`,
  ].join(" ");
}
...
var Ai = (e, t, { descriptor: r, logger: n, schemas: u }) => {
    let i = [
        `Ignored unknown option ${Kn.default.yellow(
          r.pair({ key: e, value: t })
        )}.`,
      ],
      a = Object.keys(u)
        .sort()
