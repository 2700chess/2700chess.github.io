import{j as t}from"./index-BlPo4WBo.js";import{r as b}from"./index-CDs2tPxN.js";import{q as l}from"./styled-components.browser.esm-BXlt7KuZ.js";import{a as f}from"./index-mZ8wGMve.js";import{B as x}from"./Box-CuN7tJpi.js";import"./extends-CF3RwP-h.js";import"./inheritsLoose-DR8r8Ogv.js";import"./emotion-use-insertion-effect-with-fallbacks.browser.esm-Bbbmb3_I.js";const d=({currentIndex:e,radioRefs:i,breakPoint:s=f,...n})=>{var m,u;return t.jsxs(b.Fragment,{children:[t.jsx(v,{$breakPoint:s,value:e,onChange:r=>{n.setCurrentIndex&&n.setCurrentIndex(Number(r.target.value))},children:(m=n.games)==null?void 0:m.map((r,a)=>t.jsx("option",{value:a,children:r.title},a))}),t.jsx("div",{children:(u=n.games)==null?void 0:u.map((r,a)=>t.jsxs(y,{$breakPoint:s,ref:h=>i&&(i.current[a]=h),className:e===a?"active":"",children:[t.jsx(j,{name:"gameTitle",value:r.title,checked:e===a,onChange:()=>{n.setCurrentIndex&&n.setCurrentIndex(a)}}),t.jsx("span",{children:r.title})]},a))})]})},v=l.select`
  width: 100%;
  padding: 0.3rem;
  outline: none;
  color: rgb(95, 94, 83);
...
}`,...(g=(p=o.parameters)==null?void 0:p.docs)==null?void 0:g.source}}};const P=["Component"];export{o as Component,P as __namedExportsOrder,L as default};
